...
#This is where we define the groupings of site prep treatments
SitePrepGroups <- fread("./Inputs/SitePrep_TypeMethods.csv")

#choose your fire(s) of interest
...
#### Results:
#this layer says it's an intersect, but it isn't. You should be able to replace this with any new RESULTS
# layer download
...
#this is the loop that will go through each of the fires and produce a raster for each plantation 
# "predictor". If you only need Elephant Hill, you can get rid of the loop and just run through this once.
...
for(ix in 1:length(FiresOfInterest)){
  ...
  # Check if any opening IDs are repeated
