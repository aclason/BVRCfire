...
inner_resampling = rsmp("spcv_coords", folds=10)
...
rr = resample(task_train, optFtlrn, outer_resampling, store_models = TRUE)
...
prediction = optFtlrn$predict(task_test)
...
model <- Predictor$new(optFtlrn, data = x, y = dat$dNBRCAT)
