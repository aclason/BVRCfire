...
```{r}
#this is based off pixels that was analysed
Silvic_Vars <- c("BroadBurn", "Brushed", "DebrisMade", "DebrisPiled", "Fertil", "PileBurn", 
                  "Prune", "Soil", "Spaced", "SpotBurn")

Chutanli[,colnames(Chutanli) %in% Silvic_Vars, with=FALSE]

Chutanli[,.N, by=.(BroadBurn)]
Nadina[,.N, by=.(BroadBurn)]
Verdun[,.N, by=.(BroadBurn)]
Island[,.N, by=.(BroadBurn)]
Tezzeron[,.N, by=.(BroadBurn)]
Shovel[,.N, by=.(BroadBurn)]


Chutanli[,.N, by=.(Brushed)]
Nadina[,.N, by=.(Brushed)]
Verdun[,.N, by=.(Brushed)]
Island[,.N, by=.(Brushed)]
Tezzeron[,.N, by=.(Brushed)]
Shovel[,.N, by=.(Brushed)]
```
