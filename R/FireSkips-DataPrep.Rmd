...
Populating Data for plantation skips analysis:

- this is about under what conditions (forest management) did plantations not have crown fire
- this isn't about fire skips in the whole fire
- this isn't about the deciduous component

As far as I know, we don't have the Carole Mahood layer for all of these 20+ fires.
...
Bringing in data from csvs produced in MakeFireDataTable.R

Working with RESULTS data analysis mostly
```{r}
#Fires with results:
Fire_shortList <- c("K20637","C20735","C50647","C50744","C20729","C10784","C10970", "R11796",
                    "R11498","G41607", "G51632", "R21721", "C11937",  "R11921")

#removed "VA1964", "VA1787" "C12594" because only 1 and 4 results openings in each
dt <- data.table()
...
PlantationsAge[DENUDATION =="L" & DENUDATI_5=="D"]
###########
...
#figuring out area wthin each fire severity category for the whole fire
...
merge(PlantFire_Sev,Plant_union, by=c("FIRE_NUMBE","BURN_SEVER"))
###############################################
